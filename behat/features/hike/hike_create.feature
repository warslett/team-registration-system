Feature: Hike Create
  ...
  Scenario: I can add a hiker to an event
    ...
    And I fill in "Min age" with "10"
    And I fill in "Max age" with "14"
    And I fill in "Fee Per Walker (pounds)" with "12.00"
    And I fill in "Start Time Interval (minutes)" with "5"
    And I fill in "First team start time" with "01/11/2998 09:00"
    And I fill in "Joining Info URL (eg. https://hike.org.uk/joining-info.pdf)" with "http://www.example.com"
    And I fill in "Kit List URL (eg. https://hike.org.uk/kitlist.pdf)" with "http://www.example.com"
    And I press "Save"
